...
def admin_login(request):
    if request.method == "POST":
        # Skipping authentication for now – always go to dashboard
...
def view_appointments(request):
    appointments = [
        {"id": "A001", "patient": "John Smith", "doctor": "Dr. Sarah Johnson", "date": "2024-11-12", "time": "09:00 AM", "status": "Scheduled"},
        {"id": "A002", "patient": "Alice Johnson", "doctor": "Dr. Michael Chen", "date": "2024-11-12", "time": "10:30 AM", "status": "Scheduled"},
        {"id": "A003", "patient": "Robert Brown", "doctor": "Dr. Emily Davis", "date": "2024-11-11", "time": "02:00 PM", "status": "Completed"},
        {"id": "A004", "patient": "Emily Wilson", "doctor": "Dr. Robert Wilson", "date": "2024-11-13", "time": "11:00 AM", "status": "Pending"},
        {"id": "A005", "patient": "Michael Davis", "doctor": "Dr. Sarah Johnson", "date": "2024-11-10", "time": "03:30 PM", "status": "Cancelled"},
    ]
